...
namespace Notifications
{
    ...
    public class GameNotificationsManager : MonoBehaviour
    {
        ...
        private OperatingMode mode = OperatingMode.ClearOnForegrounding | OperatingMode.RescheduleAfterClearing;
        ...
        {
            GameNotificationChannel channel = new("crypto_1", "Default Game Channel", "Generic notifications",
                GameNotificationChannel.NotificationStyle.Popup, true, true, true, true,
                GameNotificationChannel.PrivacyMode.Public, new long[1]);
            StartCoroutine(Initialize(channel));
        }
        ...
        public IEnumerator Initialize(params GameNotificationChannel[] channels)
        {
            ...
            OnForegrounding();
            Debug.Log("Notification Manager INITIALIZED!");
        }
