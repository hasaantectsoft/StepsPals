...
{
    public class RightToFrontTransition : IScreenTransitionAnimation
    {
        ...
        public RightToFrontTransition(CanvasGroup canvasGroup, bool reverse, float showDuration = 0.2f)
        {
