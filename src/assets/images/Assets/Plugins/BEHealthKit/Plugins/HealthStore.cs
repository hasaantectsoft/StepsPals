...
namespace BeliefEngine.HealthKit
{
    ...
    public partial class HealthStore : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            receivedQuantitySamplesHandlers =
                new Dictionary<HKDataType, ReceivedHealthData<List<QuantitySample>, Error>>();
            receivedCategorySamplesHandlers =
                new Dictionary<HKDataType, ReceivedHealthData<List<CategorySample>, Error>>();
            receivedCharacteristicHandlers = new Dictionary<HKDataType, ReceivedHealthData<Characteristic, Error>>();
            receivedCorrelationSamplesHandlers =
                new Dictionary<HKDataType, ReceivedHealthData<List<CorrelationSample>, Error>>();
            receivedWorkoutSamplesHandlers =
                new Dictionary<WorkoutActivityType, ReceivedHealthData<List<WorkoutSample>, Error>>();
            receivedStatisticsHandlers = new Dictionary<HKDataType, ReceivedHealthData<HealthStatistics, Error>>();
            receivedStatisticsCollectionHandlers =
                new Dictionary<HKDataType, ReceivedHealthData<HealthStatisticsCollection, Error>>();
        ...
        */
         ...
         */
        public void ReadCombinedQuantitySamples(HKDataType dataType, DateTimeOffset startDate, DateTimeOffset endDate,
        ...
        /*! @brief 				Read quantity samples & return a list of QuantitySamples.
            ...
            @param handler		Called when the function finishes executing.
         */
        public void ReadQuantitySamples(HKDataType dataType, DateTimeOffset startDate, DateTimeOffset endDate,
        ...
        /*! @brief 				Write a quantity sample.
            ...
            @param handler		Called when the function finishes executing.
         */
        public void WriteQuantitySample(HKDataType dataType, Quantity quantity, DateTimeOffset startDate,
            DateTimeOffset endDate, WroteSample handler)
        {
            ...
            {
                Debug.LogError(
                    "Error: no health data is available. Are you running on an iOS device that supports HealthKit?");
            }
        }
        ...
        /*! @brief 				Read category samples & return a list of CategorySamples.
            ...
            @param handler		Called when the function finishes executing.
         */
        public void ReadCategorySamples(HKDataType dataType, DateTimeOffset startDate, DateTimeOffset endDate,
        ...
        /*! @brief 				Write a category sample.
            ...
            @param handler		Called when the function finishes executing.
         */
        public void WriteCategorySample(HKDataType dataType, int value, DateTimeOffset startDate,
            DateTimeOffset endDate, WroteSample handler)
        {
            this.wroteSampleHandlers[dataType] = handler;
            if (this.IsHealthDataAvailable())
        ...
        /*! @brief 				Read correlation samples & return a list of CorrelationSamples.
            ...
            @param handler		Called when the function finishes executing.
         */
        public void ReadCorrelationSamples(HKDataType dataType, DateTimeOffset startDate, DateTimeOffset endDate,
        ...
        /*! @brief 				Read workout samples & return a list of WorkoutSamples.
            ...
            @param handler		Called when the function finishes executing.
         */
        public void ReadWorkoutSamples(WorkoutActivityType activityType, DateTimeOffset startDate,
            DateTimeOffset endDate, ReceivedHealthData<List<WorkoutSample>, Error> handler)
        {
        ...
        /*! @brief 				Write a workout sample.
            ...
            @param handler		Called when the function finishes executing.
         */
        public void WriteWorkoutSample(WorkoutActivityType activityType, DateTimeOffset startDate,
            DateTimeOffset endDate, WroteSample handler)
        {
         ...
         */
        public void WriteWorkoutSample(WorkoutActivityType activityType, DateTimeOffset startDate,
            DateTimeOffset endDate, Quantity calories, Quantity distance, WroteSample handler)
        {
            this.wroteSampleHandlers[HKDataType.HKWorkoutTypeIdentifier] = handler;
            if (this.IsHealthDataAvailable())
            {
         ...
         */
        public void BeginReadingPedometerData(DateTimeOffset startDate,
        ...
        public void ReadCombinedQuantityStatistics(HKDataType dataType, DateTimeOffset startDate,
            DateTimeOffset endDate, ReceivedHealthData<HealthStatistics, Error> handler)
        {
        ...
        /*! @brief 				Perform a statistics query.
            ...
            @param handler		Called when the function finishes executing.
         */
        public void ReadStatistics(HKDataType dataType, DateTimeOffset startDate, DateTimeOffset endDate,
            StatisticsOptions options, ReceivedHealthData<HealthStatistics, Error> handler)
        {
            this.receivedStatisticsHandlers[dataType] = handler;
         ...
         */
        public void ReadStatistics(HKDataType dataType, DateTimeOffset startDate, DateTimeOffset endDate,
            Predicate predicate, StatisticsOptions options, ReceivedHealthData<HealthStatistics, Error> handler)
        {
            this.receivedStatisticsHandlers[dataType] = handler;
        ...
        /*! @brief 				Perform a statistics collection query.
            ...
            @param handler		Called when the function finishes executing.
         */
        public void ReadStatisticsCollection(HKDataType dataType, Predicate predicate, StatisticsOptions options,
            DateTimeOffset anchorDate, TimeSpan interval, ReceivedHealthData<HealthStatisticsCollection, Error> handler)
        {
         ...
         */
        public void ReadStatisticsCollection(HKDataType dataType, Predicate predicate, StatisticsOptions options,
            DateTimeOffset startDate, DateTimeOffset endDate, TimeSpan interval,
        ...
        public void ReadSteps(DateTimeOffset startDate, DateTimeOffset endDate,
            ReceivedHealthData<double, Error> handler)
        {
        ...
        private Dictionary<HKDataType, ReceivedHealthData<List<CorrelationSample>, Error>>
            receivedCorrelationSamplesHandlers;

        private Dictionary<WorkoutActivityType, ReceivedHealthData<List<WorkoutSample>, Error>>
            receivedWorkoutSamplesHandlers;

        private Dictionary<HKDataType, ReceivedHealthData<HealthStatistics, Error>> receivedStatisticsHandlers;

        private Dictionary<HKDataType, ReceivedHealthData<HealthStatisticsCollection, Error>>
            receivedStatisticsCollectionHandlers;
        ...
        private void ReadQuantity(HKDataType dataType, DateTimeOffset startDate, DateTimeOffset endDate,
            bool combineSamples)
        {
            if (this.IsHealthDataAvailable())
            {
        ...
        private void ReadWorkout(WorkoutActivityType activityType, DateTimeOffset startDate, DateTimeOffset endDate,
            bool combineSamples)
        {
            if (this.IsHealthDataAvailable())
            {
        ...
        private void ReadHealthStatistics(HKDataType dataType, DateTimeOffset startDate, DateTimeOffset endDate,
            Predicate predicate, StatisticsOptions options)
        {
            if (this.IsHealthDataAvailable())
            {
                string identifier = HealthKitDataTypes.GetIdentifier(dataType);
        ...
        private void ReadHealthStatisticsCollection(HKDataType dataType, Predicate predicate, StatisticsOptions options,
            DateTimeOffset anchorDate, TimeSpan interval)
        {
            if (this.IsHealthDataAvailable())
            {
                string identifier = HealthKitDataTypes.GetIdentifier(dataType);
            ...
            #elif UNITY_EDITOR
                this._ReadStatisticsCollection_DUMMY(identifier, predicateString, optionsString, anchorStamp,
                    intervalString);
            #endif
            }
            else
            ...
            DateTimeOffset startDate, DateTimeOffset endDate, TimeSpan interval)
        {
            ...
            #elif UNITY_EDITOR
                this._ReadStatisticsCollection_DUMMY(identifier, predicateString, optionsString, startStamp,
                    intervalString);
            #endif
            }
            else
        ...
        internal void ParseHealthXML(string xmlString)
        {
            ...
            switch (rootName)
            {
                ...
                case "correlation":
                    ...
                    this.HandleResults<List<CorrelationSample>>(this.receivedCorrelationSamplesHandlers, xml,
                        corSamples);
                    return;
                case "workout":
                ...
                case "statisticsCollection":
                    ...
                    this.HandleResults<HealthStatisticsCollection>(this.receivedStatisticsCollectionHandlers, xml,
                        collection);
                    return;
                default:
                    break;
        ...
        private void HandleResults<T>(Dictionary<HKDataType, ReceivedHealthData<T, Error>> handlers, HealthData xml,
            T response)
        {
            try
            {
        ...
        private void HealthKitErrorOccurred(string xmlString)
        {
            ...
            Debug.LogError("error from HealthKit plugin: ERROR domain:" + error.domain + " code:" + error.code + " \"" +
