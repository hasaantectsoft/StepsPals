...
//     {
//         public const string healthShareUsageDescription = "StepPals uses HealthKit to track your steps.";
//         public const string healthUpdateUsageDescription = "StepPals updates health data to track your steps.";
//         public const string clinicalUsageDescription = "StepPals only requests clinical data that we need.";
//
...
//         {
//             Debug.Log($"[OnProcessScene] Processing scene: {scene.name}");
...
//                     ProcessEntitlements(path, proj, mainTarget, info, addHealthRecordsCapability);
//
//             #if UNITY_2019_3_OR_NEWER
//                 // add HealthKit capability
//                 ProjectCapabilityManager capabilities =
//                     new ProjectCapabilityManager(projPath, entitlementsRelative, null, frameworkTarget);
...
// 			// add HealthKit capability
// 			ProjectCapabilityManager capabilities =
//  new ProjectCapabilityManager(projPath, entitlementsRelative, targetName);
// 			capabilities.AddHealthKit();
//
// 			// add HealthKit Framework
...
//         }
//
//         internal static string ProcessEntitlements(string path, PBXProject proj, string target, PlistDocument info,
//             bool addHealthRecordsCapability)
//         {
...
//             Debug.LogFormat("get build property [{0}, {1} = {2}]", target, "CODE_SIGN_ENTITLEMENTS",
...
//
//                 Debug.LogFormat("add build property [{0}, {1}] => {2}", target, "CODE_SIGN_ENTITLEMENTS",
//                     entitlementsFile);
